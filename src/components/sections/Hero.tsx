      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.h1 
              className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-bold font-display mb-10 leading-[1.0] tracking-tight"
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Добавим <span className="text-gradient">звезд</span> <br className="hidden md:block" />
              Вашему <br className="hidden md:block" />
              <span className="text-gradient">бизнесу</span>
            </motion.h1>
